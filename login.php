...
<head>
  ...
  <link rel="icon" href="logomtsdk.png">
  <link rel="icon" type="image/png" href="<?php echo $base; ?>php/img/logomtsdail.png">
...
<?php ?>
<body class="hold-transition login-page" style="background:url(theme/dist/img/okeds.jpg)
